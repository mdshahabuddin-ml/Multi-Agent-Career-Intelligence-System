...
const applicationService = {
    ...
    */
    ...
    async getApplications(params = {}, signal) {
        const response = await api.get("/api/applications/", { params, signal });
        return response.data;
    },
    ...
    */
    ...
    async getStatistics(signal) {
        const response = await api.get("/api/applications/stats", { signal });
        return response.data;
    },
